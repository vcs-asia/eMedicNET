<%@ Page Language="C#" Title="Patient" MasterPageFile="~/eMedicNET.master" AutoEventWireup="true" Inherits="Patient_Patients" Codebehind="Patients.aspx.cs" %>
...
<asp:Content ContentPlaceHolderID="contentForm" runat="server">
    ...
    <asp:GridView runat="server" ID="Lst" CssClass="" DataKeyNames="PAT_ID" GridLines="None" AutoGenerateColumns="false" CellPadding="1" CellSpacing="1" AllowPaging="true" Width="100%" PageSize="20"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="COMPANY_NAME" SortExpression="COMPANY_NAME" ItemStyle-Width="24%" HeaderText="Company"/>
            ...
            <asp:TemplateField ItemStyle-Width="1%">
                <ItemTemplate>
                    <asp:HyperLink runat="server" NavigateUrl='<%# String.Format("javascript:deleteRecord({0})",HttpUtility.UrlEncode(Eval("PAT_ID").ToString()))%>' ToolTip="Delete Record"><i class="icon-trash"></i></asp:HyperLink>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField ItemStyle-Width="1%">
                <ItemTemplate>
...
<asp:Content ContentPlaceHolderID="Script" runat="server">
    <script type="text/javascript">
        ...
        function deleteRecord(patID) {
            ...
            $.ajax({
                type: 'POST',
                url: 'Patients.aspx/deleteRecord',
                data:'{patID:"' + patID + '"}',
                dataType: 'json',
