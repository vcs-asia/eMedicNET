<%@ Page Language="C#" MasterPageFile="~/eMedicNET.master" Title="Visit" AutoEventWireup="true" Inherits="Patient_Visit_1" Codebehind="Visit_1.aspx.cs" %>
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane fade" id="mdinfo">
            ...
            <div class="row-fluid">
                <div class="span4">
                    <div class="control-group">
                        <label class="control-label" for="txtExam">Consultation Notes</label>
                        <div class="controls">
            ...
            <div class="row-fluid">
                ...
                <div class="span4 offset2">
                    <div class="control-group">
                        <label class="control-label" for="txtAllergies">Urine Drug Test</label>
                        <div class="controls">
                            <asp:DropDownList runat="server" ID="lstUrineStatus">
...
<asp:Content runat="server" ContentPlaceHolderID="Script">
    <script type="text/javascript">
        function getServiceDtls(row) {
            ...
            $.ajax({
                type: 'POST',
                url: 'Visit_1.aspx/getServiceDtls',
        ...
        function addDiagnosis() {
            $.ajax({
                type: 'POST',
                url: 'Visit_1.aspx/saveDiagnosis',
