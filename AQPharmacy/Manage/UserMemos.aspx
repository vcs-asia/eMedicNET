<%@ Page Language="C#" MasterPageFile="~/eMedicNET.master" AutoEventWireup="true" Inherits="Account_UserMemos" Codebehind="UserMemos.aspx.cs" %>
    ...
    <div class="control-group">
        <div class="controls">
            <asp:DropDownList runat="server" ID="lstFields">
                <asp:ListItem Value="MEMO_USER_NAME">User</asp:ListItem>
