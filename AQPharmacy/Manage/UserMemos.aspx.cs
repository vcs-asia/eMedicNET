...
public partial class Account_UserMemos : System.Web.UI.Page
{
    ...
    private void fillGrid(string sortCol, string sortDir)
    {
        ...
        objdl = dA.returnList("SELECT MED_ID, MED_NAME, MED_GENERIC_NAME, getMedQuantity(MED_BIG_UOM, MED_SMALL_UOM, MED_CURRENT_STOCK, MED_PACKING) AS BAL, MED_STOCK_CODE, MED_FLAG FROM MEDICINE_MST WHERE MED_TYPE != 223" + searchKeyword);
