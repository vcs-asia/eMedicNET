<%@ Page Language="C#" MasterPageFile="~/eMedicNET.master" AutoEventWireup="true" Inherits="Inventory_Drug" Codebehind="Drug.aspx.cs" %>
<asp:Content ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
    </script>
</asp:Content>
<asp:Content ContentPlaceHolderID="contentForm" runat="server">
    <h3 id="headRecord">Drug</h3>
    ...
    <div class="control-group">
        <asp:Label runat="server" CssClass="control-label" Text="Min. Stock"></asp:Label>
        <div class="controls">
