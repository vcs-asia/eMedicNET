<%@ Page Language="C#" MasterPageFile="~/eMedicNET.master" AutoEventWireup="true" Inherits="Account_MyMemos" Codebehind="MyMemos.aspx.cs" %>
    ...
    <div class="control-group">
        <div class="controls">
            <asp:DropDownList runat="server" ID="lstFields">
                <asp:ListItem Value="MEMO_SUBJECT">Subject</asp:ListItem>
            </asp:DropDownList>
            ...
            <asp:Button runat="server" ID="btnNMemo" CssClass="btn" Text="New" OnCommand="newMemo" />
        </div>
    </div>
    
    <asp:GridView runat="server" ID="Lst" CssClass="" DataKeyNames="med_id" AutoGenerateColumns="false" GridLines="None" CellPadding="1" CellSpacing="1" AllowPaging="true" Width="100%" PageSize="15"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="COMPANY_NAME" SortExpression="COMPANY_NAME" ItemStyle-Width="20%" HeaderText="Name of Company" />
