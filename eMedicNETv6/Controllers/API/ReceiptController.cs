...
namespace eMedicNETv6.Controllers.API
{
    ...
    public class ReceiptController : ControllerBase
    {
        ...
        public async Task<IActionResult> Post([Bind("RecAutid,RecRecno,RecPatid,RecVstid,RecRecdt,RecTtamt,RecPdamt,RecUsrid,RecCdate,RecUdate")] Receipt model)
        {
        ...
        public async Task<IActionResult> Put(int id, [Bind("RecAutid,RecRecno,RecPatid,RecVstid,RecRecdt,RecTtamt,RecPdamt,RecUsrid,RecCdate,RecUdate")] Receipt model)
        {
            if (ModelState.IsValid)
            {
