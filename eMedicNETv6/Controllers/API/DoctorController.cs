...
namespace eMedicNETv6.Controllers.API
{
    ...
    public class DoctorController : ControllerBase
    {
        ...
        public async Task<IActionResult> Post([Bind("StfAutid,StfSname,StfIcppt,StfSpeid,StfStsex,StfTelhp,StfEmail,StfQuali,StfRmrks,StfCatid,StfPhoto,StfSpath,StfUsrid,StfState,StfCdate,StfUdate")] Staff model)
        {
        ...
        public async Task<IActionResult> Put(int id, [Bind("StfAutid,StfSname,StfIcppt,StfSpeid,StfStsex,StfTelhp,StfEmail,StfQuali,StfRmrks,StfCatid,StfPhoto,StfSpath,StfUsrid,StfState,StfCdate,StfUdate")] Staff model)
        {
            if (ModelState.IsValid)
            {
