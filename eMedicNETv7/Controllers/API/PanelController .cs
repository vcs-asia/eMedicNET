...
namespace eMedicNETv7.Controllers.API
{
    ...
    public class PanelController : ControllerBase
    {
        ...
        public async Task<IActionResult> Post([Bind("PnlAutid,PnlSname,PnlRegno,PnlAddre,PnlTelno,PnlFaxno,PnlEmail,PnlCntct,PnlCnthp,PnlActno,PnlFrmat,PnlUsrid,PnlState,PnlCdate,PnlUdate")] Panel model)
        {
        ...
        public async Task<IActionResult> Put(int id, [Bind("PnlAutid,PnlSname,PnlRegno,PnlAddre,PnlTelno,PnlFaxno,PnlEmail,PnlCntct,PnlCnthp,PnlActno,PnlFrmat,PnlUsrid,PnlState,PnlCdate,PnlUdate")] Panel model)
        {
            if (ModelState.IsValid)
            {
