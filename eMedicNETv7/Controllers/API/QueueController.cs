...
namespace eMedicNETv7.Controllers.API
{
    ...
    public class QueueController : ControllerBase
    {
        ...
        public async Task<IActionResult> Post([Bind("PtqAutid,PtqPatid,PtqQdttm,PtqIntme,PtqTmout,PtqState,PtqDscid,PtqUsrid,PtqCdate,PtqUdate")] PatientQueue model)
        {
        ...
        public async Task<IActionResult> Put(int id, [Bind("PtqAutid,PtqPatid,PtqQdttm,PtqIntme,PtqTmout,PtqState,PtqDscid,PtqUsrid,PtqCdate,PtqUdate")] PatientQueue model)
        {
            if (ModelState.IsValid)
            {
