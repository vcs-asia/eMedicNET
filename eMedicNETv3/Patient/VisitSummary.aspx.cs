...
public partial class Patient_DailySummary : System.Web.UI.Page
{
    ...
    public string getData()
    {
        ...
        if (Request.QueryString.Count > 0)
        {
            ...
            rptStr += "<br/>Visit Summary for the period of " + convertDateForForm(fdate) + " - " + convertDateForForm(tdate) + "</td></tr>";
