            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <asp:DropDownList runat="server" ID="lstType" ClientIDMode="Static">
                        <asp:ListItem Value="1">DIAGNOSIS</asp:ListItem>
                        <asp:ListItem Value="2">2</asp:ListItem>
                        <asp:ListItem Value="3">RELATION</asp:ListItem>
                        <asp:ListItem Value="4">STATUS</asp:ListItem>
                        <asp:ListItem Value="5">NATIONALITY</asp:ListItem>
                        <asp:ListItem Value="6">6</asp:ListItem>
                        <asp:ListItem Value="7">7</asp:ListItem>
                        <asp:ListItem Value="8">RELIGION</asp:ListItem>
                        <asp:ListItem Value="9">DISCIPLINE</asp:ListItem>
                        <asp:ListItem Value="10">PAYMENT TYPE</asp:ListItem>
                        <asp:ListItem Value="11">DRUG CATEGORY</asp:ListItem>
                        <asp:ListItem Value="12">DRUG FORM</asp:ListItem>
